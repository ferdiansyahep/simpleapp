        ...
        <div class="card-body">
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input required type="text" class="form-control" id="name" placeholder="{{ __('Judul Ujian') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input required type="date" class="form-control" name="tanggal_ujian" id="tanggal_ujian">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input required type="text" class="form-control" name="kode_ujian" id="kode_ujian"
